...
import static com.project256.leetcode.util.CommonUtil.decode;
import static com.project256.leetcode.util.HttpUtil.getToken;
...
public class ImageUtil {
    ...
    public static String upload(String uri, String refer, String cookies, MultipartFile file) throws IOException {
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom().build();
            ...
            if (res.getStatusLine().getStatusCode() == 200) {
                return String.valueOf(status.get("url"));
            }
            Object error = status.get("detail");
            LOGGER.error(error != null ? error.toString() : "Upload failure");
        } catch (Exception e) {
